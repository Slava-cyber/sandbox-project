...
(
    ...
    '^(userApiDelete)$' => 'adminTableActions/userDelete',
    '^(allDataApiRequest)$' => 'adminGetDataTable/allDataRelease',
    '^(EventCreateApi)$' => 'adminRecordsCreation/eventCreate',
    '^(eventAuthorIdentification)$' => 'adminRecordsCreation/eventAuthorIdentification',
